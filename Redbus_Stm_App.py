...
# Load the DataFrame
df = pd.read_csv("C:\RAJESH\Data Science\Project\RED BUS\REDBUSDATA.csv")
...
if r == "About us":
    ...
    tab1.image(r"C:\RAJESH\Data Science\Project\RED BUS\Redbus1.jpg")
    tab2.image(r"C:\RAJESH\Data Science\Project\RED BUS\Redbus2.jpg")
